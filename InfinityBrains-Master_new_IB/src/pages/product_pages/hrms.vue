            ...
            <div>
              ...
              <div class="q-pa-md q-gutter-sm">
                          ...
                          " class="form-select" aria-required="true" aria-invalid="false" v-model="city_id" required>
                            ...
                            (val) =>
                              (val && val.length > 0) || 'Please type something',
                                          ...
                                          <q-input filled disable :v-bind="list.price" v-model="products.price"  label-color="black" />
                  ...
                  /> -->
                      ...
                      w-100
                      mb-2
                    " @click="BuyConfirmation(amount_pay)">
                  ...
                  <q-dialog v-model="secondDialog" persistent transition-show="scale" transition-hide="scale">
                      <q-card class="bg-teal text-white" style="width: 300px">
                          <q-card-section>
                              <form method="post" class="p-1 m-4 mb-0 text-center d-block form-group" @submit.prevent="sendData">
  ...
  export default {
      ...
      data() {
          return {
              ...
              surl: "https://uat.infinitybrains.com/Success",
      ...
      methods: {
         ...
         async BuyConfirmation(amount_pay1) {
              //alert(this.products.price);
              // console.log(products.price);
              //this.data = response.data

              //this.amount_pay = this.products.price;
              //alert(this.amount_pay);
              //alert(this.amount_pay);
              //this.amount = this.amount_pay
             // console.warn("NOW IF CLICK THE FINAL BUY BUTTON THEN DIRECT BUY PRODUCT ", window.location.origin);
              ...
              // this.amount_pay = this.products.price;
              // if(this.amount_pay == this.products.price)
              // {
