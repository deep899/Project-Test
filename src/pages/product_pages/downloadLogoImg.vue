...
<template>
  ...
  <!-- Carousel End Here -->
  <!-- OUR PRODUTCS --><!-- This Page Text element use as a CoupenCode Text = CoupenCode -->
<template>
  <!-- Slider Carousel -->
          ...
          <div class="carousel">
            <ul class="slides">
              ...
              <li class="slide-container">
                <div class="slide-image">
                  <img
                    src="https://ib-bucketlive.s3.ap-south-1.amazonaws.com/…blic/creatives/YXGK1qfN6C936tygonpyMuWwvreBkJ.jpg"
                  />
                </div>
                <div class="carousel-controls">
                  <label for="img-3" class="prev-slide">
              ...
              <li class="slide-container">
                <div class="slide-image">
                  <img
                    src="https://ib-bucketlive.s3.ap-south-1.amazonaws.com/…blic/creatives/EmDtjsmfJ0uynQrEMOcByNXy8DRala.jpg"
                  />
                </div>
                <div class="carousel-controls">
                  <label for="img-1" class="prev-slide">
