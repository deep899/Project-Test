...
<template>
  ...
  <body>
    <div class="container">
      ...
      InfinityBrains built the IBSlaesforce app as a Free app. This SERVICE is provided by InfinityBrains at no cost and
      is intended for use as is.
      This page is used to inform visitors regarding our policies regarding the collection, use, and disclosure of
      ...
      which are accessible at IBSlaesforce unless otherwise defined in this Privacy Policy.
      <br>

      <!-- You may change your details at any time by advising us in writing via email. All
information we receive from our customers is protected by our secure server.
Redprix secure server software encrypts all customer information before it is
sent to us. Furthermore, all customer data collected is secured against
unauthorized use or access.<br> -->
      ...
      in a case of an error in the app we collect data and information (through third party products) on your phone called
      Log Data.
      This Log Data may include information such as your device Internet Protocol (“IP”) address, device name, operating
      ...
      You have the option to either accept or refuse these cookies and know when a cookie is being sent to your device. If
      ...
      thus we are striving to use commercially acceptable means of protecting it. But remember that no method of
      ...
      information from
      children under 13 years of age. In the case we discover that a child under 13 has provided us with
      ...
      contact.infinitybrains@gmail.com.
