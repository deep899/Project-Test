  ...
  <div class=" col-md-0 col-xs-12" style="">
    ...
    <div class="row">
      ...
      <div class="col-11" style="">
        <p class="text-white name" style="font-size: 1rem;">604,Luxuria Business Hub,Nr <br /> Vesu,Surat,Gujarat</p>
        <br />
      </div>
    </div>
    <div class="row">
      <div class="col-1">
        <q-icon class="material-icons text-white q-icon--big">mail_outline</q-icon>
      </div>
      <div class="col-11">
        <p class="text-white name" style="font-size: 1.1rem;">contact@infinitybrains.com</p>
      </div>
    </div>
    <div class="row">
      <div class="col-1">
      ...
      <div class="col-11">
        <p class="text-white" style="margin-left: 10% ; margin-top: -10%; font-size: 1.1rem;"> <span>Sales Enquiry  :<br/> +91
            94267 34485</span> <br /> <span style="margin-top: 40%;">Join Our Dream Team :<br/> +91 9173544779</span></p>
      </div>
      <div class="col-11">
        <div class="inline">
...
" @click="persistent = true" />
            <q-dialog v-model="persistent" persistent transition-show="scale" transition-hide="scale">
              <q-card class="bg-teal text-white" style="max-width: 300px; width: 90vw;">
                <q-card-section>
                  <label>Rise Ticket</label>
                </q-card-section>
...
.text-red {
  ...
  font-weight: bold;
  color: #E86D6D;
  font: normal normal normal 22px/27px Impact;
  margin-bottom: 10px;
  letter-spacing: 0px;
}
</style>
