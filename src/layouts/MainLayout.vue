<template>
  <q-layout view="lHh Lpr lFf">
    <transition appear enter-active-class="animated animate__fadeInDown animate__slower 3s"
      ...
      <q-header>
        ...
        <q-toolbar id="toolbar" class="tooolbars" style=" z-index: 50; margin-bottom: -100%; margin-top: 0%;">
          <q-toolbar-title>
            <a href="/" class="gt-xs">
              <!-- Logo -->
              <img scoped id="my-image" class="BgImages" src="./../assets/img/Ib_logo.png"
                alt="./../../src/assets/img/logo_blue.png"
                style=" width: 11vw; margin-left: 50px ;margin-top: 1%; margin-bottom: 0%;" />


              <img scoped id="my-image" class="BgImages" src="./../../src/assets/img/logo_blue.png" alt=""
          ...
          <div class="q-toolbar__title ellipsis">
            ...
            <router-link :to="newlink.link" class="gt-xs middle-button-10-minute-a">
              <q-btn flat dense class="middle-button-10-minute" @click="middleButtonClick">
                {{ newlink.title }}
              </q-btn>
            </router-link>
          </div>
          ...
          <div class="gt-xs links" v-for="(link, index) in essentialLinks" :key="index" v-ripple="{ color: 'yellow' }">
            <router-link class="q-mr-lg primary text-h11 header-links text-weight-bold"
              :style="{ color: (scrollPosition === 0 ? (hoverIndex === index ? 'red' : '#012A71') : '#012A71') }"
              v-bind:to="link.link" tag="button" active-class="router-link-active" @mouseover="hoverIndex = index"
...
const newLinkList = [
  {
    title: "MAKE YOUR WEBSITE/APP IN 10 MINUTES",
    icon: "10Minute",
    link: "/10M_website/page",
  },
];
